...
async function addNewItem(req, res) {
    try { 
        const {title,price,description,availableCount,category,image}= req.body
        ...
        const newItem = new ShopItem({
            ...
            availableCount,
            category,
            image // the only case I could make it work is "Assuming theres a URL pointing to the image"
        });
